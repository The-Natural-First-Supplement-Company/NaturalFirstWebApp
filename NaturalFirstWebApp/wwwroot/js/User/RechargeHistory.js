$(document).ready(function () {
    $.ajax({
        ...
        success: function (data) {
            var table;
            if ($.fn.dataTable.isDataTable('#RechargeHistoryTbl')) {
                table = $('#RechargeHistoryTbl').DataTable().columns.adjust();
            } else {
                table = $('#RechargeHistoryTbl').DataTable();
            }
            table.destroy();
            $("#RechargeHistoryTbl").DataTable({
                data: data,
                paging: true,
                pagingType:"simple",
                sort: false,
