        ...
        success: function (response) {
            ...
            */
            for (var i = 0; i < response.length; i++) {
                ...
                pageHtml += '<button class="detail" id="btnSubmit' + i + '" data-id' + i + '="' + response[i].id + '" onClick="Submit(' + i + ')">Unblock<i class="arrow right"></i></button></div></div></div>';
